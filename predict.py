...
#converting class tensor into numpy array and then converting it into a list of strings for later mapping with cat_to_name
topclas=top_cls.cpu()
topclass=topclas.numpy()
topc=topclass[0]
c=[]
for i in topc:
    c.append(str(i))
...
classnames=[cat_to_name[item] for item in c]
